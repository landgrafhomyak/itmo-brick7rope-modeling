...
BOOL Brick7RopeModeling_RegisterWindowClasses(Brick7RopeModeling_App *app)
{
    WNDCLASSEXW MainWindow_Class = {
            ...
            .lpfnWndProc = (WNDPROC) Brick7RopeModeling_MainWindow_Proc,
            .cbClsExtra = 0,
            .cbWndExtra = sizeof(Brick7RopeModeling_App *),
            .hInstance = app->hInstance,
            .hIcon = app->main_icon,
            .hCursor = LoadCursor(NULL, IDC_ARROW), //app->canvas_cursor,
            .hbrBackground = NULL,
            .lpszMenuName = NULL,
    ...
    WNDCLASSEXW ToolPanel_Class = {
            .cbSize = sizeof(WNDCLASSEXW),
            .style = CS_NOCLOSE,
            .lpfnWndProc = (WNDPROC) Brick7RopeModeling_ToolPanel_Proc,
            .cbClsExtra = 0,
            .cbWndExtra =  sizeof(Brick7RopeModeling_App *),
            .hInstance = app->hInstance,
            .hIcon = app->main_icon,
