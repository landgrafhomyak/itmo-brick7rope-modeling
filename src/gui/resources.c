...
BOOL Brick7RopeModeling_LoadResources(Brick7RopeModeling_App *app)
{
    ...
    LOAD_BUTTON_ICON(add_brick, "BUTTON_ADD_BRICK", 14);
    LOAD_BUTTON_ICON(remove_brick, "BUTTON_REMOVE_BRICK", 15);
    LOAD_BUTTON_ICON(add_rope, "BUTTON_ADD_ROPE", 16);
    LOAD_BUTTON_ICON(remove_rope, "BUTTON_REMOVE_ROPE", 17);
    LOAD_BUTTON_ICON(lock_brick, "BUTTON_LOCK_BRICK", 18);
    LOAD_BUTTON_ICON(unlock_brick, "BUTTON_UNLOCK_BRICK", 19);
    // LOAD_BUTTON_ICON(drag_brick, "BUTTON_DRAG_BRICK", 20);
